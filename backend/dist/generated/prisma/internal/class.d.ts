 ...
 * `prisma.tournament`: Exposes CRUD operations for the **Tournament** model.
  ...
  */
    ...
    /**
     * `prisma.playerOpponent`: Exposes CRUD operations for the **PlayerOpponent** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more PlayerOpponents
      * const playerOpponents = await prisma.playerOpponent.findMany()
      * ```
      */
    get playerOpponent(): Prisma.PlayerOpponentDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     ...
     * `prisma.tablePlayer`: Exposes CRUD operations for the **TablePlayer** model.
      ...
      * ```
      */
    get tablePlayer(): Prisma.TablePlayerDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
