...
export interface TableAssignment {
    tables: any[][]; // Array de arrays, cada uno es una mesa
    byePlayers: any[]; // Jugadores que reciben BYE
}
 ...
 */
export function distributePlayersIntoTables(
    players: any[]
): TableAssignment {
    const tables: any[][] = [];
    const byePlayers: any[] = [];
 ...
 */
export function generateRandomFirstRound(players: any[]): TableAssignment {
 ...
 * @returns Objeto con mesas y BYEs
 */
export function generateRankedRound(players: any[]): TableAssignment {
 ...
 */
export function generateFinalRound(players: any[]): TableAssignment {
